...
const fontSpecs_1 = require("./constants/fontSpecs");
const spaces_1 = require("./constants/spaces");
exports.defaultTheme = {
    breakpoints: [768, 1024],
    fontSpecs: fontSpecs_1.fontSpecs,
    fontSizes: fontSpecs_1.fontSizes,
    ...
    gradients: {
        backgroundGradient: 'linear-gradient(to bottom right, #33CCCC, #07A3C8)',
